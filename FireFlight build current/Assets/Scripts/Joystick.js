...
class Boundary  //change this later back to Boundary 
{
...
function Start()
{
	...
	{				
		...
		// corner of the GUI
		guiTouchOffset.x = defaultRect.width * 0.3;
		guiTouchOffset.y = defaultRect.height * 0.3;
...
function FixedUpdate() //changed to FixedUpdate
{	
